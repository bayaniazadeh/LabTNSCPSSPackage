...
#'
#' @param LABTNSCPSS_Data
#' @param col_mapping
#'
#' @examples
#' source('./LABTNSCPSS_Code/create_Data_v2.R')
#'
...
# file_path : "./LABTNSCPSS_Data/data_test.csv"
Create_data <-function(file_path){
  ...
  output_file <- paste0("LABTNSCPSS_Data/input_data_cleaned_", input_basename, ".csv")
