...
#' Possible values are the Charlson score with either ICD-10 or ICD-9-CM codes (`charlson_icd10_quan`, `charlson_icd9_quan`, `charlson_icd10_ca`,`charlson_icd10_ca` for Canadian version) and the Elixhauser score, again using either ICD-10 or ICD-9-CM (`elixhauser_icd10_quan`, `elixhauser_icd9_quan`,`elixhauser_icd10_ca` or Canadian version).
